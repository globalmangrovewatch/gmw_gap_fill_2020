...
class GenGranuleValidMsks(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for granule in granule_lst:
            print(granule)
            granule_out_file = os.path.join(kwargs['granule_out_path'], "{}.gpkg".format(granule))
            if not os.path.exists(granule_out_file):
                ...
                if (len(vld_imgs) > 0) and (len(clrsky_imgs) > 0):
                    ...
                    c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_granule_vld_clrsky_msk".format(granule))
    ...
    def run_gen_commands(self):
        self.gen_command_info(scn_db_file='/scratch/a.pfb/gmw_v2_gapfill/scripts/01_sen2_ard/03_find_dwnld_scns/sen2_scn.db',
                              ...
                              granule_out_path='/scratch/a.pfb/gmw_v2_gapfill/data/granule_vld_msks',
