...
out_img_base = "/bigdata/gmw_v25_acc_ass/palsar10_acc_rois/gmw_ls_acc_roi_"

rsgislib.imageutils.subset_to_geoms_bboxs(vrt_glb_img, vec_file, vec_lyr, "roi_id", out_img_base, "GTIFF", rsgislib.TYPE_8UINT, "tif")
