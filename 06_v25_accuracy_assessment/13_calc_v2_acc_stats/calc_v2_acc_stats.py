...
acc_stats_json_file = "gmw_v2_comp_acc_stats.json"
acc_stats_csv_file = "gmw_v2_comp_acc_stats.csv"
acc_conf_stats_json_file = "gmw_v2_comp_acc_conf_stats.json"

calc_acc_stats(vec_acc_pts_file, vec_acc_pts_lyr, ref_col, cls_col, acc_stats_json_file, acc_stats_csv_file, acc_conf_stats_json_file)

out_acc_json_sum_file = "gmw_v2_comp_acc_stats_set_sum.json"
