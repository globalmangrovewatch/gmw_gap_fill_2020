...
for i in range(60):
    ...
    if os.path.exists(vec_file):
        ...
        acc_stats_json_file = os.path.join(out_set_dir, "gmw_v2_set_{}_acc_stats.json".format(i+1))
        acc_stats_csv_file = os.path.join(out_set_dir, "gmw_v2_set_{}_acc_stats.csv".format(i+1))
        acc_conf_stats_json_file = os.path.join(out_set_dir, "gmw_v2_set_{}_acc_conf_stats.json".format(i+1))
...
acc_stats_json_file = "gmw_v2_all_acc_stats.json"
acc_stats_csv_file = "gmw_v2_all_acc_stats.csv"
acc_conf_stats_json_file = "gmw_v2_set_all_acc_conf_stats.json"
...
out_acc_json_sum_file = "gmw_v2_all_acc_stats_set_sum.json"
...
acc_stats_json_file = "gmw_v2_v2_comp_acc_stats.json"
acc_stats_csv_file = "gmw_v2_v2_comp_acc_stats.csv"
acc_conf_stats_json_file = "gmw_v2_v2_comp_acc_conf_stats.json"

calc_acc_stats(vec_acc_pts_file, vec_acc_pts_lyr, ref_col, cls_col, acc_stats_json_file, acc_stats_csv_file, acc_conf_stats_json_file)

out_acc_json_sum_file = "gmw_v2_v2_comp_acc_stats_set_sum.json"
