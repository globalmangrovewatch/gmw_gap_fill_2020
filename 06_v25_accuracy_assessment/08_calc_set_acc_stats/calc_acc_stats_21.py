...
acc_pts_dir = "../00_acc_pt_sets/gmw_acc_roi_21_cls_acc_pts"

vec_files = [os.path.join(acc_pts_dir, "gmw_acc_roi_21_cls_acc_pts_1.geojson"),
             os.path.join(acc_pts_dir, "gmw_acc_roi_21_cls_acc_pts_2.geojson"),
             os.path.join(acc_pts_dir, "gmw_acc_roi_21_cls_acc_pts_3.geojson")]
...
out_plot_file = "../99_acc_roi_plots/gmw_acc_roi_21_cls_acc_pts_intervals.png"
