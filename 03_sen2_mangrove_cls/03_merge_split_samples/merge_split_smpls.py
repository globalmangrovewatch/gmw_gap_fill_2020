...
for i in tqdm.tqdm(range(n_sets)):
    ...
    mng_test_smps_file = os.path.join(samples_dir, "mng_train_samples_{}.h5".format(i + 1))
    mng_valid_smps_file = os.path.join(samples_dir, "mng_train_samples_{}.h5".format(i + 1))
    ...
    oth_test_smps_file = os.path.join(samples_dir, "oth_train_samples_{}.h5".format(i + 1))
    oth_valid_smps_file = os.path.join(samples_dir, "oth_train_samples_{}.h5".format(i + 1))
