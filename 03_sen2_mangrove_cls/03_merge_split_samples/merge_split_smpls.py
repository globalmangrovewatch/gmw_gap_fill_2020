...
rsgislib.classification.split_sample_train_valid_test(wat_all_mskd_samples, wat_train_samples, wat_valid_samples,
                                                      wat_test_samples, 5000, 20000, 50000,
...
rsgislib.imageutils.randomSampleHDF5File(mng_all_mskd_samples, mng_valid_samples, 20000, 84)

print(rsgislib.classification.get_num_samples(wat_train_samples))
print(rsgislib.classification.get_num_samples(wat_valid_samples))

print(rsgislib.classification.get_num_samples(mng_train_samples))
print(rsgislib.classification.get_num_samples(mng_valid_samples))
...
for i in tqdm.tqdm(range(n_sets)):
    ...
    mng_valid_smps_xtr_file = os.path.join(samples_dir, "mng_valid_samples_xtr_{}.h5".format(i + 1))
    rsgislib.imageutils.mergeExtractedHDF5Data([mng_valid_smps_file, mng_valid_samples], mng_valid_smps_xtr_file)
    ...
    oth_valid_smps_xtr_file = os.path.join(samples_dir, "oth_valid_samples_xtr_{}.h5".format(i + 1))
    rsgislib.imageutils.mergeExtractedHDF5Data([oth_valid_smps_file, wat_valid_samples], oth_valid_smps_xtr_file)
