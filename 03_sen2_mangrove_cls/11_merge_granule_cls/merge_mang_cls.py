...
input_vecs = glob.glob("/scratch/a.pfb/gmw_v2_gapfill/data/sum_scn_granule_vecs/*cls_75_cls_50.gpkg")
merge_utm_vecs_wgs84(input_vecs, '/scratch/a.pfb/gmw_v2_gapfill/data/cls_75_cls_50_mangrove_cls.gpkg', 'cls_75_cls_50', out_format='GPKG',
                     n_hemi_utm_file='/scratch/a.pfb/gmw_v2_gapfill/data/meta_data/UTM_Zone_Boundaries_lyrs_north.gpkg',
                     s_hemi_utm_file='/scratch/a.pfb/gmw_v2_gapfill/data/meta_data/UTM_Zone_Boundaries_lyrs_south.gpkg')
...
input_vecs = glob.glob("/scratch/a.pfb/gmw_v2_gapfill/data/sum_scn_granule_vecs/*cls_75.gpkg")
merge_utm_vecs_wgs84(input_vecs, '/scratch/a.pfb/gmw_v2_gapfill/data/cls_75_mangrove_cls.gpkg', 'cls_75', out_format='GPKG',
                     n_hemi_utm_file='/scratch/a.pfb/gmw_v2_gapfill/data/meta_data/UTM_Zone_Boundaries_lyrs_north.gpkg',
                     s_hemi_utm_file='/scratch/a.pfb/gmw_v2_gapfill/data/meta_data/UTM_Zone_Boundaries_lyrs_south.gpkg')

input_vecs = glob.glob("/scratch/a.pfb/gmw_v2_gapfill/data/sum_scn_granule_vecs/*cls_85.gpkg")
merge_utm_vecs_wgs84(input_vecs, '/scratch/a.pfb/gmw_v2_gapfill/data/cls_85_mangrove_cls.gpkg', 'cls_85', out_format='GPKG',
                     n_hemi_utm_file='/scratch/a.pfb/gmw_v2_gapfill/data/meta_data/UTM_Zone_Boundaries_lyrs_north.gpkg',
                     s_hemi_utm_file='/scratch/a.pfb/gmw_v2_gapfill/data/meta_data/UTM_Zone_Boundaries_lyrs_south.gpkg')
