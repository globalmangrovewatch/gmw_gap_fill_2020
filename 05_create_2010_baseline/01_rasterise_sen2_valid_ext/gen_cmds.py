...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for tile in tiles:
            ...
            out_file = os.path.join(kwargs['out_dir'], '{}_S2VldMsk.kea'.format(tile_basename))
            if not os.path.exists(out_file):
                c_dict = dict()
                c_dict['tile_img'] = tile
                c_dict['vldmsk_vec'] = kwargs['vldmsk_vec']
                c_dict['vldmsk_lyr'] = kwargs['vldmsk_lyr']
    ...
    def run_gen_commands(self):
        self.gen_command_info(ref_tiles_path='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_ref_tiles/*.kea',
                              vldmsk_vec='/scratch/a.pfb/gmw_v2_gapfill/data/granule_vld_msks.gpkg',
                              vldmsk_lyr='granule_vld_msks',
...
if __name__ == "__main__":
    py_script = os.path.abspath("rasterise_vldmsk.py")
    script_cmd = "singularity exec --bind /scratch/a.pfb:/scratch/a.pfb --bind /home/a.pfb:/home/a.pfb /scratch/a.pfb/sw_imgs/au-eoed-dev.sif python {}".format(py_script)

    process_tools_mod = 'rasterise_vldmsk'
    process_tools_cls = 'RasteriseVldMsk'
