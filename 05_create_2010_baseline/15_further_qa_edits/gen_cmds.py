...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(ref_tiles_path='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_ref_tiles/*.kea',
                              addmng_qa_vec='/scratch/a.pfb/gmw_v2_gapfill/scripts/05_create_2010_baseline/15_further_qa_edits/add_mangroves_pb.gpkg',
                              addmng_qa_lyr='add_mangroves_pb',
                              rmvmng_qa_vec='/scratch/a.pfb/gmw_v2_gapfill/scripts/05_create_2010_baseline/15_further_qa_edits/rm_mangroves_pb.gpkg',
                              rmvmng_qa_lyr='rm_mangroves_pb',
