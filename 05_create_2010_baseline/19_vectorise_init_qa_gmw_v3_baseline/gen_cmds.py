...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for tile in tiles:
            ...
            out_file = os.path.join(kwargs['out_dir'], '{}_gmw_v3_init_qad.gpkg'.format(tile_basename))
            out_cmp_file = os.path.join(kwargs['out_dir'], "{}_gmw_v3_init_qad.txt".format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(ref_tiles_path='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_ref_tiles/*.kea',
                              ...
                              out_dir='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_further_qa_part2_vec')
        self.pop_params_db()
