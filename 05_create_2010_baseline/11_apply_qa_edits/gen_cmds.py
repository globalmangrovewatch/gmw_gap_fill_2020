...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for tile in tiles:
            ...
            gmw_v3_img = os.path.join(kwargs['gmw_v3_dir'], '{}_GMW2010_v2.kea'.format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(ref_tiles_path='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_ref_tiles/*.kea',
                              qa_edits_dir='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_v3_init_qa_edits',
                              gmw_v3_dir='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3',
                              gmw_v3_diff_dir='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_diff_v2_v3',
                              out_dir='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_qa',
                              tmp_dir='/scratch/a.pfb/gmw_v2_gapfill/tmp')
        self.pop_params_db()
        self.create_slurm_sub_sh("apply_gmw_v3_init_qa", 16448, '/scratch/a.pfb/gmw_v2_gapfill/logs',
