...
class RasteriseGapFill(PBPTQProcessTool):

    def __init__(self):
        super().__init__(cmd_name='rasterise_gapfill.py', descript=None)
    ...
    def required_fields(self, **kwargs):
        return ["tile_img", "gapfill_vec", "gapfill_lyr", "out_file"]
